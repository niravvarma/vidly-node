...
/*
  as we are already using express-async-errors module,
  we don't use the asyncMiddleware error handling module
...
/*
  We are passing auth here because we want certain requests to be authenticated
  before they are called
  this is achieved via middleware function - middleware/auth.js
  Thus, before request is resolved in POST method, first goes to middleware funcs
  and then proceeds from middleware function if success
*/
